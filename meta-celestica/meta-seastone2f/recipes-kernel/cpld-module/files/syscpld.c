...
static const i2c_dev_attr_st syscpld_attr_table_seastone[] = {
	{
	  "version",
	  NULL,
			...
			const struct i2c_device_id *id)
{
    ...
    if(board_type == 0) {
        printk(KERN_INFO "Seastone2F CPLD driver loading\n");
        n_attrs = sizeof(syscpld_attr_table_seastone) / sizeof(syscpld_attr_table_seastone[0]);
        syscpld_attr_table = syscpld_attr_table_seastone;
    }
