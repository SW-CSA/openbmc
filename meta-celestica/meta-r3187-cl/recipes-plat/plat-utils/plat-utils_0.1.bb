...
SRC_URI = "file://ast-functions \
           ...
           file://setup_sensors_ivystone.sh \
           file://power_monitor_fishbone.py \
           file://power_monitor_ivystone.py \
           file://fru-util \
           file://come_power.sh \
           file://mount_emmc.sh \
           file://us_monitor.sh \
...
do_install() {
  ...
  install -m 755 power_monitor_ivystone.py ${D}${localbindir}/power_monitor_ivystone.py

  install -m 0755 rc.local ${D}/mnt/rc.local

  install -m 755 setup_i2c_fishbone.sh ${D}${sysconfdir}/init.d/setup_i2c_fishbone.sh
  install -m 755 setup_i2c_ivystone.sh ${D}${sysconfdir}/init.d/setup_i2c_ivystone.sh
  ...
  install -m 755 setup_sensors_ivystone.sh ${D}${sysconfdir}/init.d/setup_sensors_ivystone.sh
