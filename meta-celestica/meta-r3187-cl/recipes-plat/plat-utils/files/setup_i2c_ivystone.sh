...
((psu_present=$(cat /sys/bus/i2c/devices/i2c-0/0-000d/psu_1_present | head -n 1)))
((psu_power=$(cat /sys/bus/i2c/devices/i2c-0/0-000d/psu_1_status | head -n 1)))
...
((psu_present=$(cat /sys/bus/i2c/devices/i2c-0/0-000d/psu_2_present | head -n 1)))
((psu_power=$(cat /sys/bus/i2c/devices/i2c-0/0-000d/psu_2_status | head -n 1)))
if [ $psu_present = 0 ]; then
    if [ $psu_power = 1 ]; then
...
((psu_present=$(cat /sys/bus/i2c/devices/i2c-0/0-000d/psu_3_present | head -n 1)))
((psu_power=$(cat /sys/bus/i2c/devices/i2c-0/0-000d/psu_3_status | head -n 1)))
if [ $psu_present = 0 ]; then
    if [ $psu_power = 1 ]; then
...
((psu_present=$(cat /sys/bus/i2c/devices/i2c-0/0-000d/psu_4_present | head -n 1)))
((psu_power=$(cat /sys/bus/i2c/devices/i2c-0/0-000d/psu_4_status | head -n 1)))
if [ $psu_present = 0 ]; then
    if [ $psu_power = 1 ]; then
